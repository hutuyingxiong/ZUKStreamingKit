...
TODO: Add long description of the pod here.
  ...
  s.ios.deployment_target = '8.0'
	...
	s.public_header_files = 'ZUKStreamingKit/Pod/Library/include/**/*.h'
  s.source_files = 'ZUKStreamingKit/Pod/Library/include/**/*.h'
  s.default_subspec = "precompiled"

  s.subspec "precompiled" do |ss|
    ss.preserve_paths         = "ZUKStreamingKit/Pod/Library/include/**/*.h", 'Pod/Library/lib/*.a'
    ss.vendored_libraries   = 'ZUKStreamingKit/Pod/Library/lib/*.a'
